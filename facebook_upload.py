...
def login_and_post():
    ...
    # Image ka path aur text Node.js se aayega
    ...
    # Logs foran screen par show karne ke liye
    ...
    try:
        ...
        # ==========================================
        # STEP 2: TEXT TYPE KARNA (DYNAMIC TEXT)
        # ==========================================
        ...
        if text_box:
            # Yahan direct post_text input kar diya
        ...
        # ==========================================
        # STEP 3: IMAGE UPLOAD (DYNAMIC IMAGE)
        # ==========================================
        print("▶️ STEP 3: Photo upload kar rahe hain...", flush=True)
        ...
        if photo_icon:
            ...
            if os.path.exists(image_path):
                ...
                if file_input:
                    ...
                    print(f"✅ Photo attached: {image_path}", flush=True)
                    time.sleep(6)
            else:
                print(f"⚠️ Image nahi mili path par: {image_path}", flush=True)
        ...
        if post_btn:
            ...
            print("✅ 'Post' button daba diya.", flush=True)
        else:
        ...
        if share_now_btn:
            ...
            time.sleep(8)
            print("🎉 BINGO! Facebook Image Post 100% Successful.", flush=True)
